...
var PolylineTextPath = {
    ...
    setText: function (text, options) {
        ...
        /* fix by geomaster to allow the underlying path to receive click events and the like: */
        //textNode.style.pointerEvents = textPath.style.pointerEvents = 'none';
        ...
        //textNode.addEventListener('click', function(){alert('debug');});
